    ...
    virtual std::string evaluateString()
    {
      switch (getType())
      {
        case TYPE_NUMBER:
        {
          ...
          oss << const_cast<ExpNode*>(this)->evaluateNumber();
          return oss.str();
        }
        case TYPE_BOOL:
          return const_cast<ExpNode*>(this)->evaluateBool() ? "true" : "false";
        default:
          return std::string("");
      }
    }
...
/////////////////////////////////////////////////////////////////////////////////////
// NODO DE CONSTANTE DE TIPO STRING
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
// NODO DE VARIABLE DE TIPO STRING
/////////////////////////////////////////////////////////////////////////////////////
class StringVariableNode : public ExpNode
{
private:
  std::string _id;

public:
  explicit StringVariableNode(const std::string &id) : _id(id) {}
...
/////////////////////////////////////////////////////////////////////////////////////
// NODO DE FUNCIÓN STRING CON 1 PARÁMETRO
/////////////////////////////////////////////////////////////////////////////////////
class BuiltinStringFunctionNode_1 : public ExpNode
{
private:
  std::string _id;
  ExpNode *_exp;
...
public:
  BuiltinStringFunctionNode_1(const std::string &id, ExpNode *exp)
      : _id(id), _exp(exp) {}
...
public:
  ConcatNode(ExpNode *L, ExpNode *R) : _left(L), _right(R) {}
...
/////////////////////////////////////////////////////////////////////////////////////
// NODO DE ASIGNACIÓN DE VARIABLE DE TIPO STRING
/////////////////////////////////////////////////////////////////////////////////////
class AssignmentStmtStringNode : public Statement
{
private:
  std::string _id;
  ExpNode *_exp;
...
public:
  AssignmentStmtStringNode(const std::string &id, ExpNode *exp)
      : _id(id), _exp(exp) {}
...
////////////////////////////////////////////////////////////////////////////////
//////
// STATEMENT TO PRINT A STRING EXPRESSION
////////////////////////////////////////////////////////////////////////////////
class PrintStringStmt : public Statement
{
 private:
  ExpNode *_exp; //!< Expression that evaluates to a string

 public:
  explicit PrintStringStmt(ExpNode *exp) : _exp(exp) {}
...
////////////////////////////////////////////////////////////////////////////////
//////
// STATEMENT TO READ A STRING INTO A VARIABLE
////////////////////////////////////////////////////////////////////////////////
class ReadStringStmt : public Statement
{
 ...
 public:
  explicit ReadStringStmt(std::string id) : _id(id) {}
...
class RepeatStmt : public Statement
{
 ...
 public:
  RepeatStmt(Statement *body, ExpNode *cond) : _body(body), _cond(cond) {}
...
class ForStmt : public Statement
{
 ...
 public:
  ForStmt(const std::string &id, ExpNode *start, ExpNode *end, ExpNode *step,
          Statement *body)
...
////////////////////////////////////////////////////////////////////////////////
//////
// SWITCH CASE SUPPORT STRUCT
////////////////////////////////////////////////////////////////////////////////
struct SwitchCase
{
  ExpNode *cond;
  Statement *stmt;
  SwitchCase(ExpNode *c, Statement *s) : cond(c), stmt(s) {}
};
...
class SwitchStmt : public Statement
{
 private:
  ExpNode *_exp;
  std::list<SwitchCase *> *_cases; // cases; default has cond==NULL

 public:
  SwitchStmt(ExpNode *e, std::list<SwitchCase *> *cases)
      : _exp(e), _cases(cases) {}
