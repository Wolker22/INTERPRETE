...
namespace lp
{
	...
	public:
		...
		*/
		AssignmentStmt(std::string id, ExpNode *expression)
			: _id(id), _exp(expression), _asgn(NULL) {}
	...
	public:
		...
		*/
		IfStmt(ExpNode *condition, Statement *statement1)
			: _cond(condition), _stmt1(statement1), _stmt2(NULL) {}
	...
	*/
	...
	public:
		...
		*/
		SwitchStmt(ExpNode *exp, std::list<struct Case *> *cases, Statement *defaultStmt = NULL)
